...
public class AsyncHelp extends AsyncTask<String, Void, String> {
	...
	public AsyncHelp(String username, ArrayList<String> selectedItems) {
	...
	protected String doInBackground(String... urls) {
		...
		for (String item : selectedItems){
			url = "https://web.ist.utl.pt/ist170515/add-helper.php?Creator="+creator+"&Date="+date+"&Time="+time+"&Helper="+username;
			result = GET(url);
		}
		return "";
	}
